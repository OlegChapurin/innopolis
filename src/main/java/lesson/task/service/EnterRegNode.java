 ...
 */
public class EnterRegNode extends ChainLink {
    /**
     *
    ...
    public void handler(ServletRequest servletRequest, ServletResponse servletResponse) throws ServletException, IOException {
        ...
        if(servletRequest.getParameter("enterReg") != null) {
            Visitor user = creatUser(servletRequest);
            userSqlRequest.registerUser(user);
