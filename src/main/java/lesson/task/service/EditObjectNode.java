 ...
 */
public class EditObjectNode extends ChainLink {
    /**
     *
    ...
    public void handler(ServletRequest servletRequest, ServletResponse servletResponse) throws ServletException, IOException {
        ...
        if(servletRequest.getParameter("editObject") != null) {
            editUser(servletRequest,session);
            session.setAttribute("typePage", TypePage.EDIT.getTypePage());
